...
COLOR_HEX = {
    ...
    # === Expanded color mappings (added 2026-05-01) ===
    # Comfort Colors signature pigments
    "pepper": "#3F3F3D", "blue jean": "#5F7A99", "ivory": "#E8DDC1",
    "crimson": "#7B1F2C", "denim": "#4A6B8A", "true navy": "#1B2C55",
    "flo blue": "#5C7BA8", "blue spruce": "#2E4844", "light green": "#A8D5A8",
    "seafoam": "#9FD8B8", "watermelon": "#E5566D", "chambray": "#8FA6B8",
    "butter": "#F5E89A", "neon violet": "#9B5FCC", "yam": "#C75A2D",
    "neon pink": "#FF6FA0", "neon blue": "#3FA1E0",
    "amethyst": "#7A4D8C", "citrine": "#D9B440", "clay": "#B0664A",
    "fern": "#6B8E5C", "ocean": "#3F7AA8", "smoke": "#7A7A7A",
    "violet": "#7C5AA0", "orchid": "#C77FB8", "terracotta": "#B86A50",
    "topaz blue": "#5494B8", "dusk": "#7A8FA6", "rose quartz": "#D8A5B0",
    "espresso": "#3D2920", "hydrangea": "#7A8FBC", "peachy": "#F2B499",
    "chalky mint": "#9FD8B8", "moss": "#5C6B3A", "graphite": "#3F4042",
    "berry": "#7A2A4D",
    # Heathers
    "heather": "#A8ABAE", "dark heather grey": "#47484B",
    "heather charcoal": "#3F4343", "heather forest": "#3D5246",
    "heather kelly": "#1F8557", "heather maroon": "#5E3340",
    "heather purple": "#5A4078", "heather sapphire": "#2E548C",
    "heather slate": "#5C6770", "heather indigo": "#3D4A6B",
    "heather military green": "#5C6B4A", "graphite heather": "#5A5C5F",
    "olive heather": "#7A7B5C",
    # Brand-specific (Port Authority, Sport-Tek, OGIO, Richardson)
    "petrol": "#2E5566", "wasabe": "#A8B85A", "loden": "#4A5538",
    "dark loden": "#3A4329", "quarry": "#6F7378", "coffee": "#6F4E37",
    "cream": "#F2EBD8", "kelly": "#008E5A", "army olive": "#5B5C3D",
    "army green": "#4B5320", "olive": "#6B7240", "olive drab": "#5C5A3D",
    "lilac": "#C7B0D9", "smoke blue": "#6B859E", "smoke gray": "#7A7A7A",
    "smoke green": "#5C6B5A", "columbia blue": "#9BCBEB",
    "patina green": "#8AA89F", "patina": "#8AA89F",
    "amber gold": "#D4A52B", "vegas gold": "#C5A56F", "old gold": "#C9A227",
    "dark gold": "#B8860B", "buck": "#A89072", "biscuit": "#D9C8A8",
    "birch": "#E8DDC1", "tan": "#C8A878", "light tan": "#D8C5A0",
    "pale khaki": "#C2B591", "driftwood": "#9C8B73", "rhino": "#5C6065",
    "stone": "#8E8579", "stone gray": "#9A9690", "dark stone": "#6B6357",
    "dark olive": "#3D4029",
    # Greys
    "ice grey": "#C8CCD1", "ice gray": "#C8CCD1", "ash grey": "#D4D2D0",
    "light grey": "#B7BABE", "light gray": "#B7BABE",
    "medium grey": "#9A9DA0", "medium gray": "#9A9DA0",
    "dark grey": "#5C5E61", "dark gray": "#5C5E61",
    "gunmetal": "#4A4D52", "silver": "#C4C4C4", "aluminum": "#A8ABAE",
    "iron grey": "#5C5E61", "iron gray": "#5C5E61",
    "pewter": "#8B8E91", "steel": "#71797E", "slate": "#637480",
    "fog": "#C8CCD1", "graphite gray": "#5A5C5F", "graphite grey": "#5A5C5F",
    # Blues
    "blue steel": "#4A6580", "midnight": "#1A2138",
    "midnight navy": "#1A2138", "deep navy": "#1A2138",
    "atlantic": "#2B5C7A", "atlantic blue": "#2B5C7A", "lake": "#3F6B85",
    "tidewater": "#3F7A8A", "marine blue": "#1F4566",
    "neptune blue": "#3F708A", "true blue": "#2C5FA8",
    "tropic blue": "#1F8FBF", "aqua": "#5BC4D5", "aqua blue": "#5BC4D5",
    "turquoise": "#3FB8C2", "moonlight blue": "#4A6B8A",
    "ombre blue": "#3D6788", "cobalt blue": "#0B4D8C", "cobalt": "#0B4D8C",
    "horizon blue": "#7AA8C4", "patriot blue": "#1B355C",
    "carolina": "#8DB4D4", "mineral blue": "#4A6B8A",
    # Yellows / oranges / reds / pinks
    "lime": "#A4F713", "lime green": "#A4F713", "neon coral": "#FF6B5C",
    "coral": "#E6826F", "salmon": "#F0816B", "peach": "#F2B499",
    "apricot": "#F2A878", "rust": "#A04B2B", "burnt orange": "#9C3F1A",
    "dark orange": "#D45A1F", "hot pink": "#E6428A",
    "raspberry": "#A82E5C", "wine": "#5E2438", "burgundy": "#5E1F2D",
    "burnt red": "#9C3A2E", "red rock": "#A04330",
    "lemon": "#F5E040", "amber": "#D49A1F", "candy yellow": "#F2D43F",
    "mineral red": "#9C3A48",
    # Browns / earth
    "chocolate chip": "#4A3528", "chocolate": "#3D2A1C",
    "mocha": "#6B4A33", "caramel": "#9C6B3F",
    "saddle": "#8B5A2B", "saddle brown": "#8B5A2B",
    "rich brown": "#5C3A2E", "grey brown": "#7A6657",
    "mink beige": "#A89378",
    # Greens
    "patriot green": "#1A4D2E", "deep green": "#1A3D2A",
    "hunter": "#2A4F3A", "hunter green": "#2A4F3A",
    "evergreen": "#1F3A2C", "sage": "#9CAA8B", "sage green": "#9CAA8B",
    "neon kelly": "#1FA864", "mineral teal": "#3F6E70",
    # Whites / off-whites
    "antique white": "#F0E8D6", "off white": "#F2EDE0",
    "ecru": "#D9CDB6", "vintage white": "#F0EBD8", "snow": "#F8F8F8",
    "garment dyed": "#D9CDB6",
    # Vintage / mineral / camo brand fallbacks
    "vintage red": "#9C3340", "vintage navy": "#2A3A55",
    "vintage black": "#2A2A2A",
    "mossy oak": "#5C5E3F", "realtree": "#5A5238",
    "kryptek": "#5A5538", "multicam": "#7B6E50",
}
